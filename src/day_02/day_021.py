...
def what_games_are_possible(path):
    ...
    references = {"red":12, "green":13, "blue":14}
    id_sum = 0
    for ind in games.keys():
        ...
        if max_green <= references["green"] and max_red <= references["red"] and max_blue <= references["blue"]:
            id_sum += ind
...
if __name__ == "__main__":
    ...
    result = what_games_are_possible(path)
    print(result)